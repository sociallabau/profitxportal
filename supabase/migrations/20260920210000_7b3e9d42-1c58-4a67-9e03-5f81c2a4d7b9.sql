...
-- ---------------------------------------------------------------------------
-- 6. The questions clients actually keep asking, pulled out of the Q&As and
-- momentum calls by Claude, and shown as prompts on the Ask Dan page.
-- Everyone can read them; only admins rebuild them.
-- ---------------------------------------------------------------------------
